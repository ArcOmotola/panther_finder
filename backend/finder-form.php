...
if (isset($_POST['submit'])) {
    ...
    if ($item_name == "" || $item_address == "" || $item_phone == "" || $time_found == "" || $description == "" || $visibility == "") {
        ...
        try {
            ...
            // }
            $register_sql = "INSERT INTO finder_reports (user_id,title,description,image,phone,category_id,color_id,visibility) VALUES (:user_id,:title,:description,:image,:phone,:category_id,:color_id,:visibility)";
            $params = [
                'user_id' => $user_id,
                'title' => $item_name,
