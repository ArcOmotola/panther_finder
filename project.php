...
$projects = 'SELECT * FROM finder_reports WHERE user_id = :user_id ORDER BY created_at DESC';
                            ...
                            <div class="col-lg-4 col-md-6 portfolio-item  wow fadeInUp" data-wow-delay="0.1s">
                                <div class="rounded overflow-hidden">
                                    ...
                                    <div class="bg-light p-4">
                                        ...
                                        <a type="button" class="btn <?= $project['status'] == "delivered" ? "btn-success" : "btn-warning" ?> btn-lg" href="finder-form.php?id=<?= $project['id'] ?>">
                                            <?= $project['status'] == "delivered" ? "Claimed" : $project['status'] ?>
                                        </a>
                                    </div>
                                </div>
                            </div>
